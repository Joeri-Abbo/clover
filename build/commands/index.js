...
const Generate = ({
  ...
  (0, _react.useEffect)(() => {
    const allResults = [...project, ...plugin, ...core].filter(clover => clover.name.indexOf('clover-init')).map(clover => ({
      value: clover.path,
      label: clover.name
    }));
  ...
  (0, _react.useEffect)(() => {
     ...
     */
    const candidates = generators === null || generators === void 0 ? void 0 : generators.filter(clover => (0, _lodash.isEqual)(clover.label, name));
...
exports.default = _default;
},{"../../src/components/input/select-input":"../src/components/input/select-input/index.js","./../../src/components/App":"../src/components/App.js","./../../src/middleware/GeneratorMiddleware":"../src/middleware/GeneratorMiddleware.js","./../../src/hooks/useGeneratorIndex":"../src/hooks/useGeneratorIndex.js"}],"index.js":[function(require,module,exports) {
"use strict";
